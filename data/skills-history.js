window.__SKILLS_HISTORY__ = {
  ...
  "registry": {
    ...
    "vercel-labs/agent-skills/deploy-to-vercel": {
      ...
      "introZh": "这个技能主要是用来完成上线发布和自动化流程的，适合后端/平台工程师、研发团队在云与基础设施时使用。它的重点是把复杂问题拆成可执行步骤，让你更快动手。 这个技能更偏向「云与基础设施」场景，重点解决“完成上线发布和自动化流程”问题，适合后端/平台工程师快速上手。",
      "useCases": [],
      "audience": [
        "后端/平台工程师",
        "研发团队"
    ...
    "mcp-use/mcp-use/chatgpt-app-builder": {
